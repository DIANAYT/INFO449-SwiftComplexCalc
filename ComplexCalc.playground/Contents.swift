...
calc.add(lhs: -2, rhs: 1) == -1
calc.subtract(lhs: -1, rhs: -2) == 1
calc.subtract(lhs: -1, rhs: 2) == -3
calc.multiply(lhs: -1, rhs: -5) == 5
calc.multiply(lhs: -2, rhs: 2) == -4
calc.divide(lhs: -10, rhs: -2) == 5
calc.divide(lhs: -6, rhs: 2) == -3
// empty arrays
calc.avg([]) == 0
calc.add([]) == 0
calc.multiply([]) == 1
